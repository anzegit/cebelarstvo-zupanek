...
<ul>
    ...
    <li><tt>nbbc/tools/collect_smileys.php</tt> &nbsp; &nbsp; &nbsp; (used for creating an HTML <a
                href="app_smiley.html">table of smileys</a>)
    </li>
    <li><tt>nbbc/tools/Makefile</tt> &nbsp; &nbsp; &nbsp; (used for creating <tt>nbbc.php</tt> from the other files)
    </li>
    <li><tt>nbbc/tools/merge.pl</tt> &nbsp; &nbsp; &nbsp; (used for creating <tt>nbbc.php</tt> from the other files)
    </li>
...
<ul>
    <li>You can use the compressed version of NBBC, which loads a little faster and is packed
        ...
        and in your PHP script, you simply <tt>require_once("nbbc.php")</tt>.
    </li>
    <li>You can use the uncompressed version of NBBC, which loads a little slower and is multiple
        ...
        and in your PHP script, you simply <tt>require_once("nbbc_main.php")</tt>.
    </li>
</ul>
