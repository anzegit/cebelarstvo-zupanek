<div class='tipbox'>
    <div class='tipbox_header'>
        <div class='tipbox_star'>*</div>
        <div><b>Tech Tip</b></div>
    </div>
    <div class='tipbox_content'>
        <div class='tipbox_content2'>
            <p>This section is intended primarily for experienced software engineers and
                ...
                these concepts, we recommend the classic <a
                        href="http://www.amazon.com/Compilers-Principles-Techniques-Tools-2nd/dp/0321486811/ref=pd_bbs_sr_1?ie=UTF8&s=books&qid=1216066409&sr=8-1">Dragon
                    Book</a>
                and Hopcroft and Ullman's <a
                        href="http://www.amazon.com/Introduction-Automata-Theory-Languages-Computation/dp/0321462254/ref=sr_1_3?ie=UTF8&s=books&qid=1216066500&sr=1-3">Little
                    Book of Evil</a>,
...
<ul>
    <li><b><tt>BBCODE_TAG</tt> with no matching <tt>BBCODE_ENDTAG</tt></b>: When text is being collected
        at the end, the initial tag will have an invisible <tt>BBCODE_ENDTAG</tt> added to the end of the input.
    </li>
    <li><b><tt>BBCODE_ENDTAG</tt> with no matching <tt>BBCODE_TAG</tt></b>: This is caught during the
        ...
        as a new <tt>BBCODE_TEXT</tt> entry.
    </li>
    <li><b>Tag inside a class that doesn't allow it</b>: If, for example, a user places a
        ...
        plain text and pushed as a <tt>BBCODE_TEXT</tt> token.
    </li>
...
<ol>
    ...
    <li><b><tt>NL</tt></b> read. <tt>WS</tt> on the stack is popped (NL consumes nearby WS), and the NL is pushed onto
        the stack.
    </li>
    ...
    <li><b><tt>[/i]</tt></b> read. Search down the stack for a <tt>[i]</tt>. Remove all tokens in between and
        ...
        Push the resulting HTML, "<tt>&lt;i&gt;World&lt;/i&gt;</tt>", onto the stack.
    </li>
    ...
    <li><b><tt>[/center]</tt></b> read. Search down the stack for a <tt>[center]</tt>. Remove all tokens in between and
        convert them to a string. Pass string to <tt>[center]</tt>'s processing function, and pop <tt>[center]</tt> from
        stack.
        Push the resulting HTML, "<tt>&lt;div style="text-align:center;"&gt;Hello,
            &lt;i&gt;World&lt;/i&gt;!&lt;/div&gt;</tt>", onto the stack.
        Remove any trailing NL or WS tokens, since <tt>[/center]</tt> consumes newlines.
    </li>
