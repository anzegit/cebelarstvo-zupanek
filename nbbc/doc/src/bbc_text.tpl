...
<p class='bblib'><b><tt>[s]...[/s]</tt></b><br/>
    The <tt>[s]</tt> tag adds a <strike>strikeout</strike> to its contents. The ending <tt>[/s]</tt> tag is required.
</p>

<a name="ref_lib_style_sup"></a>
<p class='bblib'><b><tt>[sup]...[/sup]</tt></b><br/>
    The <tt>[sup]</tt> tag formats its contents as <sup>superscript</sup>. The ending <tt>[/sup]</tt> tag is required.
</p>
...
<p class='bblib'><b><tt>[spoiler]...[/spoiler]</tt></b><br/>
    The <tt>[spoiler]</tt> tag formats its contents as a <span style='color:#000;background-color:#000'>spoiler</span>
    (select this text with your mouse to see the spoiler). The ending <tt>[/spoiler]</tt> tag is required.</p>
...
<p class='bblib'><b><tt>[acronym="description"]keyword[/acronym]</tt></b><br/>
    ...
    can be helpful, like this: <span class='acronym' title="description">keyword</span>. The ending <tt>[/acronym]</tt>
    tag is required.</p>
...
<div style='margin-left: 2em;margin-top:0.5em;'>The ending <tt>[/size]</tt> tag is required, and the size given must be
...
<p class='bblib'><b><tt>[color=n]...[/color]</tt></b><br/>
    ...
    <tt>[color=goldenrod]Shiny&nbsp;gold[/color]</tt> will appear as <span
            style='color:goldenrod;'>Shiny&nbsp;gold</span>,
...
<p class='bblib'><b><tt>[font=n]...[/font]</tt></b><br/>
    ...
    <span style='font-family:"Times New Roman";'>Times New Roman</span>, or generic font names, like <span
            style='font-family:cursive;'>cursive</span>.
...
<ul style='margin-left:3em;'>
    ...
    <li><tt>sans-serif</tt> - A sans-serif font, like Helvetica or Arial (also <tt>sansserif</tt>, <tt>sans serif</tt>,
        and just <tt>sans</tt>)
    </li>
