...
<ul>
    ...
    <li><b><tt>code</tt></b>: A block-like region that reproduces its contents exactly.<br/>
        <i>Usually contained by</i>: Blocks, list items, columns.<br/>
        <i>Can usually contain:</i> (nothing; body is verbatim)
    </li>
</ul>
...
<table align='center' class='class_containers'>
    ...
    <tr>
        ...
        <th colspan='7'>Can be placed within this class*:</th>
    </tr>
    <tr>
        <th colspan='2' class='empty'></th>
        <th>block</th>
    ...
    <tbody>
    <tr>
        <th rowspan='9'>Tag<br/ >of<br/ >class:</th>
        <th>block</th>
        <td>Yes</td>
        <td>.</td>
        <td>.</td>
    ...
    <tr>
        <th rowspan='3'>Special<br/>content:</th>
        <th>[plaintext]</th>
        <td>Yes</td>
        <td>Yes</td>
        <td>Yes</td>
