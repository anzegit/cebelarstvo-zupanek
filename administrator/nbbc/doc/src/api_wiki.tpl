...
<div class='api'>
    ...
    <div class='api_descr'>This function returns the current wiki URL, as set by
        ...
        <a href="ref_parser_GetDefaultWikiURL">GetDefaultWikiURL()</a>.
    </div>
...
<div class='api'>
    ...
    <div class='api_info_block'><b>Notes:</b><br/><br/>
        ...
        non-Roman characters like <span style='font-size:13pt;'>&#1488;</span> and <span
                style='font:13pt Batang,"MS Gothic","MS Mincho",Arial'>&#23470;</span> are converted to
