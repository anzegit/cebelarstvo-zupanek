...
<p class='bblib' style='margin-bottom:0;margin-top:0'><b><tt>[quote name="John" date="July 4, 2008"
            url="http://www.foo.com"]...[/quote]</tt></b>
...
<div style='margin-left:2em;'>
    ...
    <div class='output'>
        <div class="bbcode_quote">
            <div class="bbcode_quote_head"><a href="http://www.ushistory.org/Declaration/document/index.htm">Thomas
                    Jefferson wrote on July 4, 1776:</a></div>
            <div class="bbcode_quote_body">We hold these truths to be self-evident:<br/>
                That all men are created equal.
            </div>
        </div>
