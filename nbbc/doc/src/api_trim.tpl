...
<div class='api'>
    ...
    <div class='api_descr'>This function controls how NBBC removes whitespace from the
        ...
        as in the <a href="app_rule.html">whitespace-removal parameters for a rule</a>.
    </div>
    ...
    <div class='api_info'><b>Common Examples:</b><br/>
        ...
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; then
        any non-newline whitespace found past that newline.
    </div>
</div>
...
<div class='api'>
    ...
    <div class='api_descr'>This function returns the current whitespace pre-trimming pattern.
        See <a href="api_trim.html#ref_parser_SetPreTrim">SetPreTrim()</a> for more details.
    </div>
...
<div class='api'>
    ...
    <div class='api_descr'>This function returns the current whitespace post-trimming pattern.
        See <a href="api_trim.html#ref_parser_SetPostTrim">SetPostTrim()</a> for more details.
    </div>
