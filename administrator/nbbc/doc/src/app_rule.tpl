...
<ul>
    <li><b><tt>'mode'</tt></b> &nbsp; &nbsp; &nbsp; &nbsp; (<i>Default value:</i> <tt>BBCODE_MODE_SIMPLE</tt>)<br/>
        ...
        <ul>
            <li><tt>BBCODE_MODE_SIMPLE</tt>: Replaces the tag with the text defined in <tt>'simple_start'</tt>
                and <tt>'simple_end'</tt>.
            </li>
            <li><tt>BBCODE_MODE_CALLBACK</tt>: Calls a callback function or method to format the tag.
                The formatting function is specified in the <tt>'method'</tt> parameter.
            </li>
            <li><tt>BBCODE_MODE_INTERNAL</tt>: Calls an internal formatting function in the BBCode parser.
                The formatting function is specified in the <tt>'method'</tt> parameter, which must be a string.
            </li>
            <li><tt>BBCODE_MODE_LIBRARY</tt>: Calls a formatting function that's part of the Standard BBCode Library
                (the BBCodeLibrary object).
                The formatting function is specified in the <tt>'method'</tt> parameter, which must be a string.
            </li>
        </ul>
        <br/>
    ...
    <li><b><tt>'method'</tt></b> &nbsp; &nbsp; &nbsp; &nbsp; (<i>Default value:</i> <tt>""</tt>)<br/>
        ...
        <ul>
            <li><tt>BBCODE_MODE_CALLBACK</tt>: This may be a string, for calling a function,
                ...
                define a callback function. See the section on <a href="usage_call.html">callback tags</a> for more
                details
                on how to set up a <tt>BBCODE_MODE_CALLBACK</tt> tag.
            </li>
            <li><tt>BBCODE_MODE_INTERNAL</tt>: This is a string, the name of an internal
                method of an instance of class <a href="api.html"><tt>BBCode</tt></a>.
            </li>
            <li><tt>BBCODE_MODE_LIBRARY</tt>: This is a string, the name of a method of an
                instance of class <tt>BBCodeLibrary</tt>.
            </li>
        </ul>
        <br/>
    ...
    <li><b><tt>'content'</tt></b> &nbsp; &nbsp; &nbsp; &nbsp; (<i>Default value:</i> <tt>BBCODE_OPTIONAL</tt>)<br/>
        ...
        <ul>
            <li><tt>BBCODE_REQUIRED</tt>: Non-empty content must be provided for this tag to
                ...
                this tag will be rendered verbatim rather than formatted.
            </li>
            ...
            <li><tt>BBCODE_VERBATIM</tt>: Content is optional, but any tags or special formatting
                ...
                the block that contains the verbatim content.
            </li>
        </ul>
        <br/></li>
    ...
    <li><b><tt>'after_endtag'</tt></b> &nbsp; &nbsp; &nbsp; &nbsp; (<i>Default value:</i> <tt>""</tt>)<br/>
        ...
        &nbsp; &nbsp; &nbsp; <tt>'sn'&nbsp;</tt> &nbsp; &nbsp; &nbsp; &nbsp; Remove all non-newline whitespace, then a
        single newline if it exists.<br/>
        &nbsp; &nbsp; &nbsp; <tt>'ns'&nbsp;</tt> &nbsp; &nbsp; &nbsp; &nbsp; Remove a single newline if it exists, then
        all non-newline whitespace.<br/>
        &nbsp; &nbsp; &nbsp; <tt>'sns'</tt> &nbsp; &nbsp; &nbsp; &nbsp; Remove all non-newline whitespace, then a single
        newline if it exists,<br/>
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; then
        any non-newline whitespace found past that newline.<br/>
        <br/></li>
    ...
    <ul>
        <li><tt>BBCODE_REQUIRED</tt>: (The most common setting.) An ending <tt>[/tag]</tt> must be
            ...
            the user, the start tag will be ignored and formatted verbatim.
        </li>
        <li><tt>BBCODE_OPTIONAL</tt>: An end tag is optional, and the content of the start
            ...
            to the end of the document, whichever comes first.
        </li>
        <li><tt>BBCODE_PROHIBIT</tt>: An end tag is disallowed. The start tag has no
            ...
            for tags like <tt>[rule]</tt> and <tt>[wiki]</tt> that have no content.
        </li>
    </ul>
    <br/></li>
