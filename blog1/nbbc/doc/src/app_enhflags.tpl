...
<ul>
    <li style='margin-bottom:1em;'><b><tt>v</tt> - Verbatim.</b> Do not apply any formatting to the variable; use its
        exact text,
    ...
    <li style='margin-bottom:1em;'><b><tt>w</tt> - Clean up whitespace.</b> This causes all non-newline whitespace, such
        as
        control codes and tabs, to be collapsed into individual space characters.
    </li>

    <li><b><tt>e</tt> - Apply <a href="api_misc.html#ref_parser_HTMLEncode"><tt>BBCode::HTMLEncode()</tt></a></b> to the
        variable.
    </li>
    <li><b><tt>h</tt> - Apply <tt>htmlspecialchars()</tt></b> to the variable.</li>
    <li><b><tt>k</tt> - Apply <a href="api_wiki.html#ref_parser_Wikify"><tt>BBCode::Wikify()</tt></a></b> to the
        variable.
    </li>
