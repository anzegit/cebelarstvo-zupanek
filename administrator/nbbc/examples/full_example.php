...
<head>
    ...
    <style><!--
        ...
        h1 {
            font: bold 16pt Arial, Helv, Helvetica;
            text-align: center;
        }
...
?>
                ...
                <td style='padding-left:1em;vertical-align:top;'>
                    ...
                    <input type='checkbox' <?php if ($enable_smileys) print "checked='checked'" ?> name='smileys'/>
                    Enable Smileys<br/>
                    <input type='checkbox' <?php if ($autourl_mode) print "checked='checked'" ?> name='autourl'/>
                    Auto-Detect URLs<br/>
                    <input type='checkbox' <?php if ($plain_mode) print "checked='checked'" ?> name='plain'/> Use
                    Plain-HTML Mode<br/>
                    <input type='checkbox' <?php if ($allow_ampersand) print "checked='checked'" ?> name='ampersand'/>
                    Allow Ampersands<br/>
                    <input type='checkbox' <?php if ($tag_marker == '<') print "checked='checked'" ?>
