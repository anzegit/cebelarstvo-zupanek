...
<p class='bblib'><b><tt>[img]...[/img]</tt></b><br/>
    ...
    <br/>
    &nbsp; &nbsp; &nbsp; &nbsp; <tt>Google's logo:
        [img]http://www.google.com/intl/en_ALL/images/logo.gif[/img]</tt><br/>
    &nbsp; &nbsp; &nbsp; &nbsp; --&gt; Google's logo: <img src="http://www.google.com/intl/en_ALL/images/logo.gif"
                                                           align='middle'/><br/>
...
<p class='bblib'><b><tt>[rule]</tt></b><br/>
    ...
    <a href="api_rule.html#ref_parser_SetRuleHTML">SetRuleHTML</a> function. The <tt>[rule]</tt> tag does not have an
    end tag.</p>
