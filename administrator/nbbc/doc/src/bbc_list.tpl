...
<div align='center'>
    <table class='list_table'>
        ...
        <tr>
            <th>1</th>
            <td>Ordered list using Arabic numerals</td>
            <td>1, 2, 3...</td>
            <td><tt>decimal</tt></td>
        </tr>
        <tr>
            <th>01</th>
            <td>Ordered list using numbers with a leading zero</td>
            <td>01, 02, 03..., 10, 11...</td>
            <td><tt>decimal-leading-zero</tt></td>
        </tr>
        <tr>
            <th>A</th>
            <td>Ordered list using capital letters</td>
            <td>A, B, C...</td>
            <td><tt>upper-alpha</tt></td>
        </tr>
        <tr>
            <th>a</th>
            <td>Ordered list using lowercase letters</td>
            <td>a, b, c...</td>
            <td><tt>lower-alpha</tt></td>
        </tr>
        <tr>
            <th>I</th>
            <td>Ordered list using capital Roman numerals</td>
            <td>I, II, III, IV...</td>
            <td><tt>upper-roman</tt></td>
        </tr>
        <tr>
            <th>i</th>
            <td>Ordered list using lowercase Roman numerals</td>
            <td>i, ii, iii, iv...</td>
            <td><tt>lower-roman</tt></td>
        </tr>
        <tr>
            <th>greek</th>
            <td>Ordered list using lowercase Greek letters</td>
            <td>&#945;, &#946;, &#947;...</td>
            <td><tt>lower-greek</tt></td>
        </tr>
        <tr>
            <th>armenian</th>
            <td>Ordered list using Armenian numbering</td>
            <td></td>
            <td><tt>armenian</tt></td>
        </tr>
        <tr>
            <th>georgian</th>
            <td>Ordered list using Georgian numbering</td>
            <td>an, ban, gan...</td>
            <td><tt>georgian</tt></td>
        </tr>
        <tr>
            <th>circle</th>
            <td>Unordered list using circle-bullets</td>
            <td>
        ...
        <tr>
            <th>disc</th>
            <td>Unordered list using disc-bullets</td>
            <td>
        ...
        <tr>
            <th>square</th>
            <td>Unordered list using square-bullets</td>
            <td>
                <ul style='margin-top:0;margin-bottom:0;list-style-type:square;'>
                    <li>&nbsp;</li>
                </ul>
            </td>
            <td><tt>square</tt></td>
