...
<p>If your tag is a new <b>replaced item</b> tag (like [img], for example), you'll probably want to use these classes:
</p>
...
<p>If your tag is a new <b>inline style</b> tag (like [b] or [font], for example), you'll probably want to use these
    classes:</p>
<xmp class='code'>array(
    ...
    'class' => 'inline',
...
<p>If your tag is a new <b>link</b> tag (like [url] or [email], for example), you'll probably want to use these classes:
</p>
<xmp class='code'>array(
    ...
    'class' => 'link',
...
<p>If your tag is a new <b>block</b> tag (like [quote] or [center], for example), you'll probably want to use these
    classes:</p>
<xmp class='code'>array(
    ...
    'class' => 'block',
