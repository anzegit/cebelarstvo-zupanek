...
<div class='api'>
    <div class='api_head'>string <b>BBCode::DoTag</b> ( string $<tt>action</tt> , string $<tt>tag_name</tt> ,
        string $<tt>default_value</tt> , array $<tt>params</tt> , string $<tt>contents</tt> )
    </div>
    ...
    <div class='api_info'><b>Parameters:</b>
        <ul class='api_params'>
            ...
            <li><tt><i>tag_name</i></tt>: The name of the tag being processed, without surrounding brackets
                or an end-tag slash (/), as in "<tt>b</tt>" or "<tt>quote</tt>".
            </li>
            ...
            <li><tt><i>params</i></tt>: This is an array of key =&gt; value parameters given in the tag.
                For example, in the tag <tt>[tag="foo"&nbsp;bar="baz"&nbsp;chocolate="good"]</tt>, this array would
                be:<br/>
                ...
                array, and will always contain the same values as $<tt>tag_name</tt> and $<tt>default_value</tt>.
            </li>
    ...
    <div class='api_info'><b>Return Value:</b> For <tt>BBCODE_CHECK</tt>, this must return <i>true</i> if
        ...
        <tt>BBCODE_OUTPUT</tt>, this must return clean HTML output text.
    </div>
...
<div class='api'>
    ...
    <div class='api_descr'>This function enables NBBC's built-in <i>debug mode</i>. When in debug mode,
        ...
        is not working correctly. You should <i>not</i> enable debug mode in production environments.
    </div>
    <div class='api_info'><b>Parameters:</b>
        <ul class='api_params'>
            <li><tt><i>enable</i></tt>: Whether to turn debug mode on or off; if this parameter is <i>true</i>,
                ...
                browser; if this parameter is <i>false</i>, no debugging information will be displayed.
            </li>
        </ul>
    </div>
...
<div class='api'>
    ...
    <div class='api_descr'>This function returns the current state of NBBC's built-in <i>debug mode</i>.
        See <a href="api_core.html#ref_parser_SetDebug">SetDebug()</a> for more details.
    </div>
