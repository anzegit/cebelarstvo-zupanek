...
<ul>
    ...
    <li><b><tt>$action</tt></b> - Always one of <tt>BBCODE_CHECK</tt> or <tt>BBCODE_OUTPUT</tt>,
        provided to indicate why this function was called and what it should return.
    </li>
    <li><b><tt>$name</tt></b> - The tag name: In the <tt>[border]</tt> example, this would contain the string "<tt>border</tt>".
    </li>
    <li><b><tt>$default</tt></b> - The default value of the tag. If the user were to type <tt>[border=1 color=red]</tt>,
        the default value would be "<tt>1</tt>".
    </li>
    ...
    <li><b><tt>$content</tt></b> - Only valid when <tt>$action</tt> is <tt>BBCODE_OUTPUT</tt>,
        ...
        <tt>[border=1 color=red]Hello[/border]</tt>, <tt>$content</tt> would contain the string "<tt>Hello</tt>".
    </li>
</ul>
        ...
        <div class='tipbox_content2'>
            ...
            <ul>
                <li><b><tt>$default</tt></b> contains exactly what the user typed, and has not been passed through
                    ...
                    If you output this value, you should clean it up before outputting it.
                </li>
                <li><b><tt>$params</tt></b> all contain exactly what the user typed, and none of them have been passed
                    through
                    <tt>htmlspecialchars()</tt> or <tt>htmlentities()</tt> or any other cleanup function.
                    If you output this value, you should clean it up before outputting it.
                </li>
                <li><b><tt>$content</tt></b> is always pure, clean output HTML, or pure, clean output plaintext,
                    depending on
                    whether it's outputting in HTML or plaintext mode.
                </li>
                <li><b>Your callback function's return value</b> must always be pure, clean output HTML, or pure, clean
                    output
                    plaintext, depending on whether it's outputting in HTML or plaintext mode.
                </li>
