            ...
            <ul>
                ...
                <li><b><a href="api_smiley.html" style="color:#000;">Smiley Functions:</a></b>
                    <ul>
                        ...
                        <li><a href="api_smiley.html#ref_parser_GetDefaultSmileyDir">BBCode::GetDefaultSmileyDir</a>
                        </li>
                        ...
                        <li><a href="api_smiley.html#ref_parser_GetDefaultSmileyURL">BBCode::GetDefaultSmileyURL</a>
                        </li>
                ...
                <li><b><a href="api_repl.html" style="color:#000;">Replaced Item Functions:</a></b>
                    <ul>
                        ...
                        <li><a href="api_repl.html#ref_parser_GetDefaultLocalImgDir">BBCode::GetDefaultLocalImgDir</a>
                        </li>
                        ...
                        <li><a href="api_repl.html#ref_parser_GetDefaultLocalImgURL">BBCode::GetDefaultLocalImgURL</a>
                        </li>
                    </ul>
                </li>
