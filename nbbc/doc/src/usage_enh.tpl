...
<div class='output'>
    <div style='border: 2px solid blue;'>This has a blue border!</div>
</div>
...
<div class='output_header'>Output:</div>
<div class='output'>
    <div style='border: 2px solid blue;font-size:40pt;'>This has a blue border!</div>
</div>
    ...
    <div class='tipbox_content'>
        <div class='tipbox_content2'>
            <p><b>Don't know what regular expressions are?</b> They're used pretty frequently in NBBC,
                ...
                introductions/tutorials to regular expressions, both <a href="http://perldoc.perl.org/perlrequick.html">short
                    intros</a>
            ...
            <ul>
                ...
                <li><b><tt>[a-f0-9z]</tt></b> - a character class, matching "a" through "f", and "0" through "9", and
                    "z"
                </li>
...
<xmp class='code'>[border color="blue;font-size:40pt" size=2]This has a blue border![/border]
    [border color="green" size=2]This has a green border![/border]
</xmp>
<div class='output_header'>Output:</div>
...
<div class='output_header'>Output:</div>
<div class='output'>
    <div style='border: 1px solid blue;'>This has a blue border!</div>
</div>
