...
<!--                <li>
                ...
                <li>
                    <a href="koristno.php">Ali ste vedeli</a>
                </li>
                <li>
                    <a href="izdelki_vsi.php">Nakup</a>
                </li>
                <li>
                    <a href="blog.php">nasveti</a>
                </li>
                <li>
                    <a href="contact.php">Kontakt</a>
                </li>
                <li>
                    <a href="viewcart.php" class="cart-link" title="Košarica"><i class="glyphicon glyphicon-shopping-cart"></i></a>
                </li>
