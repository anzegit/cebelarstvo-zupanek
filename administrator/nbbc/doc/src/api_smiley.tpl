...
<div class='api'>
    ...
    <div class='api_descr'>This function adds a new smiley. Smileys, or emoticons, are character
        ...
        will be removed by this function, so this can also replace smileys as well as adding new smileys.
    </div>
    <div class='api_info'><b>Parameters:</b>
        <ul>
            <li><i>name</i>: The name of a smiley you wish to add or replace, like "<tt>:-)</tt>" or
                ...
                so that they are not accidentally mistaken for non-smiley text.
            </li>
            <li><i>image</i>: The name of an image located in the current smileys directory that
                you wish to have displayed in place of the text symbol.
            </li>
        </ul>
    </div>
...
<div class='api'>
    ...
    <div class='api_descr'>This function un-defines the given smiley --- in short,
        this causes NBBC to stop recognizing the given smiley and converting it to an image.
    </div>
    <div class='api_info'><b>Parameters:</b>
        <ul>
...
<div class='api'>
    ...
    <div class='api_descr'>This function returns the image for a given smiley,
        by name, the same array as was most recently given to <a
                href="api_smiley.html#ref_parser_AddSmiley">AddSmiley()</a>
        for that same smiley.
    </div>
    <div class='api_info'><b>Parameters:</b>
        <ul>
    ...
    <div class='api_info'><b>Return values:</b> The image for the given smiley, if the smiley
        has been defined; if it has not, the return value is <tt>false</tt>.
    </div>
</div>
...
<div class='api'>
    ...
    <div class='api_descr'>This function removes <i>all</i> smileys currently associated with this
        ...
        is useful if you want to replace the default smileys entirely with your own custom smileys.
    </div>
...
<div class='api'>
    ...
    <div class='api_descr'>This function returns the default smiley image name
        ...
        This provides you with an easy way to look up a smiley provided by the <a href="app_smiley.html">Standard
            Smileys</a>.
    </div>
    <div class='api_info'><b>Parameters:</b>
        <ul>
    ...
    <div class='api_info'><b>Return values:</b> The Standard Smiley's image name for the
        given text, if the text has been defined as a smiley; if it has not, the return value is <tt>false</tt>.
    </div>
</div>
...
<div class='api'>
    ...
    <div class='api_descr'>This function changes the smiley
        ...
        the same image name that would be returned by <a href="#ref_parser_GetDefaultSmiley">GetDefaultSmiley()</a>.
    </div>
    <div class='api_info'><b>Parameters:</b>
        <ul>
            <li><i>name</i>: The text form of the smiley whose image name you'd like to revert to its default setting.
            </li>
        </ul>
    </div>
</div>
...
<div class='api'>
    ...
    <div class='api_descr'>This function returns a key =&gt; value array that contains <i>all</i>
        of the default smileys --- all of the smileys in the set of <a href="app_smiley.html">Standard Smileys</a>. Each
        key
        ...
        many times, once for each text string in the Standard Smileys, only much, much faster.
    </div>
    <div class='api_info'><b>Parameters:</b> None.</div>
...
<div class='api'>
    ...
    <div class='api_descr'>This function causes the BBCode object's entire current set of smileys to be
        ...
        object will be deleted, and the new, default smiley definitions will be installed instead.
    </div>
    <div class='api_info'><b>Parameters:</b> None.</div>
    <div class='api_info'><b>Return Value:</b> None.</div>
</div>
...
<div class='api'>
    ...
    <div class='api_descr'>This function returns the current smiley directory.
        See <a href="api_smiley.html#ref_parser_SetSmileyDir">SetSmileyDir()</a> for more details.
    </div>
    <div class='api_info'><b>Return values:</b> Returns the current smiley directory.
        If no smiley directory has been set, this returns simply "smileys".
    </div>
</div>
...
<div class='api'>
    ...
    <div class='api_descr'>This function returns the current smiley URL.
        See <a href="api_smiley.html#ref_parser_SetSmileyURL">SetSmileyURL()</a> for more details.
    </div>
    <div class='api_info'><b>Return values:</b> Returns the current smiley URL.
        If no smiley URL has been set, this returns simply "smileys".
    </div>
</div>
...
<div class='api'>
    ...
    <div class='api_descr'>This function determines whether smileys like <tt>:-)</tt> are
        converted to images or whether they are ignored and treated as plain text.
    </div>
    <div class='api_info'><b>Parameters:</b>
        <ul class='api_params'>
            <li><tt><i>enable</i></tt>: If set to <tt>true</tt>, all defined smileys are converted to
                ...
                smileys are treated the same as any other text and passed to the output unchanged.
            </li>
        </ul>
    </div>
</div>
...
<div class='api'>
    ...
    <div class='api_descr'>This function returns the current enable-smileys state.
        See <a href="api_smiley.html#ref_parser_SetEnableSmileys">SetEnableSmileys()</a> for more details.
    </div>
    <div class='api_info'><b>Return values:</b> Returns <tt>true</tt> or <tt>false</tt>, depending
        on whether smileys are being converted to images.
    </div>
</div>
