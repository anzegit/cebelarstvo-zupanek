...
<ul>
    ...
    <li><tt><b>bbcode_firstcolumn</b></tt>: <tt>&lt;td&gt;</tt> that contains the first column in a group.<br/><br/>
    </li>
    ...
    <li><tt><b>bbcode_quote_head</b></tt>: <tt>&lt;div&gt;</tt> that wraps around the "So-and-so wrote:" title area.
    </li>
    <li><tt><b>bbcode_quote_body</b></tt>: <tt>&lt;div&gt;</tt> that wraps around content of a code block.<br/><br/>
    </li>
